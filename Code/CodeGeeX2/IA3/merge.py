...
def get_args():
    ...
    parser.add_argument("--base_model_name_or_path", type=str, default="bigcode/large-model")   # 基础模型路径，对应 train.sh 中的 $model
    parser.add_argument("--peft_model_path", type=str, default="/")     # LoRA 权重路径，对应 $output_dir/Best_Loss
    parser.add_argument("--merged_output_dir", type=str, default=None)   # 合并后保存的输出目录
